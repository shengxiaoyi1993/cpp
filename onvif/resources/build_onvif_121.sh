...
TARGET_DIR="gsoap_bin_121"

BIN_DIR=`pwd`/${TARGET_DIR}
...
# cd ..
  ...
  wget -O gsoap_2.8.121.zip ftp://pub:9900@192.168.1.238/lib/gsoap_2.8.121.zip
  unzip gsoap_2.8.121.zip
  cd gsoap-2.8/
  ...
  cp ${BIN_DIR}/bin/* OnvifFrameWork/level1/level2/GenerateSource/
