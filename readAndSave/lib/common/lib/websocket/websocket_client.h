...
class client {
    enum status { CLOSED = constants::connection_status::ST_CLOSED,
                  CONNECTING_TCP = constants::connection_status::ST_CONNECTING_TCP,
                  CONNECTED_TCP = constants::connection_status::ST_CONNECTED_TCP,
                  CONNECTING_WS = constants::connection_status::ST_CONNECTING_WS,
                  ESTABLISHED = constants::connection_status::ST_ESTABLISHED,
                  CLOSING_WS = constants::connection_status::ST_CLOSING_WS,
                  CLOSED_WS = constants::connection_status::ST_CLOSED_WS,
                  CLOSING_TCP = constants::connection_status::ST_CLOSING_TCP};
private:
    socket_t sockfd;
    int status;
    send_queue wx_queue;
