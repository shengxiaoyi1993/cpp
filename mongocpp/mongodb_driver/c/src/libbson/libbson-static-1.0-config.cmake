...
find_library (BSON_STATIC_LIBRARY bson-static-1.0 PATHS "${PACKAGE_PREFIX_DIR}/lib64" NO_DEFAULT_PATH)

set (BSON_STATIC_LIBRARIES ${BSON_STATIC_LIBRARY})

foreach (LIB  -lgcc -lgcc_s -lc -lgcc -lgcc_s /usr/lib64/librt.so /usr/lib64/libm.so -pthread)
