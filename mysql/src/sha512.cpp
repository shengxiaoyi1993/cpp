...
const uint64_t k[] = { 0x428a2f98d728ae22, 0x7137449123ef65cd, 0xb5c0fbcfec4d3b2f, 0xe9b5dba58189dbbc, 0x3956c25bf348b538,
...
string getSha512ForUint(uint v_num){
    std::vector<unsigned char> buffer;
    string numberstring=integerToString(v_num);
//    cout<<"numberstring:"<<numberstring<<endl;
    buffer.clear();
    buffer.assign(numberstring.begin(),numberstring.end());
    return hash512(buffer);
