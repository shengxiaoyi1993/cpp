...
void thread_pool::thread_loop()
{
  ...
  while(m_is_started)
  {
    ...
    cout<<"take: group: "<<task.num_group<<" seq: "<<task.num_seq<<endl;
    cout<<"take: in: "<<task.frame_in.dir_root<<" out: "<<task.frame_out.dir_root<<endl;
...
void thread_pool::taskProcess(const task_t & v_para){
    cout<<"conclude: group: "<<v_para.num_group<<" seq: "<<v_para.num_seq<<endl;
    cout<<"conclude: in: "<<v_para.frame_in.dir_root<<" out: "<<v_para.frame_out.dir_root<<endl;

    process_runway::stitchImageBlock(v_para);
}
